...
/****** Object:  Job [scs_Log_Backup_Report]    Script Date: 2/21/2017 9:51:55 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 2/21/2017 9:51:55 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'scs_Log_Backup_Report', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [scs_Log_Backup_Latency]    Script Date: 2/21/2017 9:51:55 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'scs_Log_Backup_Latency', 
		@step_id=1, 
...
where a.backup_type = ''''L'''' and datediff(hour,rb.rbrecient_backup,getdate()) > 4''

SET @MSG = ''Logs not backed up in 4 Hours''
